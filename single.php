                 ...
                 while($row =mysqli_fetch_assoc($result))
                                              {
                                                        $i++;
                                                                                     $emparray[$i] = $row;
                                                                                     $movie_trailer_path=$emparray[$i]['movie_trailer_path'];
...
?>
					<div class="song">
						<div class="song-info">
							<h3> <?php echo $movie_name ?>  - Official Trailer </h3>
					</div>
						<div class="video-grid-single-page-agileits" >
							<div data-video="<?php echo $movie_trailer_path ?>" id="video"> <img src="<?php echo $movie_img_path ?>" alt="" class="img-responsive" /> </div>
						</div>
					</div>
